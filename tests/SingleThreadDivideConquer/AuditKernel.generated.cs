...
/// <summary>
/// Bounded base-2^16 arithmetic kernels for single-threaded power. Scheduling and
/// runtime handoff live in SingleThreadBigIntegerPower. Accumulation is carry-free;
/// normalization stays scalar. Large operands use System.Numerics.BigInteger.
/// </summary>
internal static class AuditKernel
{
    ...
    //
    // Left-to-right power multiplies by the original Int64 base, at most four
    // limbs. Keep the existing bounded asymmetric window for those products;
    // it does not permit large balanced schoolbook multiplication.
    ...
    internal const int MaximumAccumulatorLimbCount =
    ...
    internal static bool CanMultiplyInCustomWindow(
        int leftLength,
        int rightLength)
    {
        int resultLength =
    ...
    internal static bool CanSquareInCustomWindow(
        int length) =>
        checked(length * 2) <=
        MaximumSquareResultLimbCount;

    internal static ushort[] MultiplyMagnitude(
        ushort[] left,
        ushort[] right,
    ...
    internal static ushort[] SquareMagnitude(
        ushort[] value,
        ulong[] accumulatorWorkspace,
        CancellationToken cancellationToken)
    {
    ...
    internal static void AccumulateSixteenProductsAvx2(
        Span<ulong> accumulator,
    ...
    internal static void AccumulateEightProductsSse2(
        Span<ulong> accumulator,
        int destinationStart,
    ...
    internal static ushort[] FromUInt64(
        ulong value)
    {
        if (value == 0)
        {
