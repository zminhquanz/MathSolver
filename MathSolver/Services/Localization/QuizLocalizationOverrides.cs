...
internal static class QuizLocalizationOverrides
{
    private static readonly IReadOnlyDictionary<string, string> Vietnamese =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Quiz.TrueFalseMode"] = "✅❌ Đúng / Sai",
            ["Quiz.MultipleChoiceMode"] = "🔢 4 đáp án",
            ...
            ["Quiz.TrueAnswer"] = "✅ Đúng",
            ["Quiz.FalseAnswer"] = "❌ Sai",
            ["Quiz.NextQuestion"] = "➡️ Câu tiếp theo",
    ...
    private static readonly IReadOnlyDictionary<string, string> English =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Quiz.TrueFalseMode"] = "✅❌ True / False",
            ["Quiz.MultipleChoiceMode"] = "🔢 4 choices",
            ...
            ["Quiz.TrueAnswer"] = "✅ True",
            ["Quiz.FalseAnswer"] = "❌ False",
            ["Quiz.NextQuestion"] = "➡️ Next question",
