...
internal static class QuizLocalizationOverrides
{
    private static readonly IReadOnlyDictionary<string, string> Vietnamese =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Quiz.LlmResourceHint"] = "4 luồng CPU • tối đa 240 token • giải phóng model khỏi RAM sau mỗi lần tạo",
            ["Quiz.SelectModelPickerTitle"] = "Chọn model GGUF cho giáo viên AI",
            ["Quiz.ImportingModel"] = "Đang chuẩn bị model trên thiết bị...",
            ["Quiz.ModelReady"] = "Model đã sẵn sàng. Bấm Tạo đề bằng AI.",
            ["Quiz.InvalidModelFile"] = "Chỉ hỗ trợ file model định dạng .gguf.",
    ...
    private static readonly IReadOnlyDictionary<string, string> English =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Quiz.LlmResourceHint"] = "4 CPU threads • up to 240 output tokens • model released from RAM after each generation",
            ["Quiz.SelectModelPickerTitle"] = "Choose a GGUF model for the AI teacher",
            ["Quiz.ImportingModel"] = "Preparing the model on this device...",
            ["Quiz.ModelReady"] = "The model is ready. Select Create with AI.",
            ["Quiz.InvalidModelFile"] = "Only .gguf model files are supported.",
