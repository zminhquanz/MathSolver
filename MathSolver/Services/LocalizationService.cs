...
public static class LocalizationService
{
    ...
    private static Dictionary<string, string> BuildEnglishMap()
    {
        ...
        [
            ...
            ("Kiểu thiết bị", "Device form factor"),
            ...
            ("Tiến trình 64-bit", "64-bit process"),
            ...
            ("Chọn tập lệnh SIMD", "Select SIMD instruction set"),
            ...
            ("Đang nghỉ trước bài đo {0}", "Resting before the {0} benchmark"),
            ("Mỗi kiểu được đo trong 10 giây, nghỉ 3 giây giữa các bài test và lấy kết quả cao nhất. Float/Double hiển thị MFLOPS/GFLOPS; Int32/Int64 hiển thị MOPS/GOPS.", "Each type is measured for 10 seconds, with a 3-second rest between tests, and the best result is retained. Float/Double use MFLOPS/GFLOPS; Int32/Int64 use MOPS/GOPS."),
