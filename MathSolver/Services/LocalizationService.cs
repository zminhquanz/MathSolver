...
public static class LocalizationService
{
        ...
        string fieldName)
    {
        ...
        var fieldMap =
                ...
                StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["độ dài cạnh a"] = "side length a",
                ["chiều dài a"] = "length a",
                ["chiều rộng b"] = "width b",
                ["độ dài đáy a"] = "base length a",
                ["độ dài cạnh b"] = "side length b",
                ["độ dài cạnh c"] = "side length c",
                ["chiều cao h"] = "height h",
                ["cạnh góc vuông a"] = "leg a",
                ["cạnh góc vuông b"] = "leg b",
                ["cạnh huyền c"] = "hypotenuse c",
                ["bán kính r"] = "radius r",
                ["đáy a"] = "base a",
                ["đáy b"] = "base b",
                ["cạnh bên c"] = "side c",
                ["cạnh bên d"] = "side d",
                ["đường chéo d₁"] = "diagonal d₁",
                ["đường chéo d₂"] = "diagonal d₂",
                ["độ dài cạnh bên b"] = "side length b",
                ["bán kính đáy r"] = "base radius r",
                ["đường sinh l"] = "slant height l",
                ["tổng"] = "the sum",
                ["hiệu"] = "the difference",
                ["tích"] = "the product",
                ["thương"] = "the quotient",
    ...
    private static Dictionary<string, string> BuildEnglishMap()
    {
        ...
        [
            ...
            ("Tính chu vi, diện tích, diện tích bề mặt và thể tích", "Calculate perimeter, area, surface area, and volume"),
            ("1. Chọn loại hình học", "1. Choose a geometry category"),
            ("Hình học mặt phẳng", "Plane geometry"),
            ("Hình học không gian", "Solid geometry"),
            ("2. Chọn hình", "2. Choose a shape"),
            ("Chọn hình", "Choose a shape"),
            ("Chọn một hình để xem công thức và nhập dữ liệu.", "Choose a shape to view its formulas and enter dimensions."),
            ("Công thức và hình minh họa", "Formula and diagram"),
            ("3. Chọn kiểu số", "3. Choose a number type"),
            ("Số nguyên", "Integer"),
            ("Số thập phân", "Decimal"),
            ("4. Nhập kích thước", "4. Enter dimensions"),
            ("Tất cả kích thước phải lớn hơn 0.", "All dimensions must be greater than 0."),
            ("Tính toán", "Calculate"),
            ("Dữ liệu không hợp lệ", "Invalid data"),
            ("Kết quả", "Results"),
            ("Cách tính", "Calculation"),
            ("Đầu vào và kết quả dùng Decimal. Phần hiển thị được làm tròn tối đa 10 chữ số sau dấu chấm.", "Inputs and results use Decimal. Displayed values are rounded to at most 10 decimal places."),
            ("Vui lòng chọn một hình học.", "Please choose a shape."),
            ("Loại hình học chưa được hỗ trợ.", "This geometry category is not supported."),
            ("Hình học mặt phẳng này chưa có bộ tính toán.", "This plane shape does not yet have a calculator."),
            ("Hình học không gian này chưa có bộ tính toán.", "This solid does not yet have a calculator."),
            ("Ba cạnh không tạo thành tam giác hợp lệ.", "The three sides do not form a valid triangle."),
            ("Ba cạnh không thỏa mãn định lý Pythagore a² + b² = c².", "The three sides do not satisfy the Pythagorean theorem a² + b² = c²."),
            ("Kết quả thập phân vượt quá phạm vi Decimal mà ứng dụng hỗ trợ.", "The decimal result exceeds the Decimal range supported by the app."),
            ("Vui lòng nhập {0}.", "Please enter {0}."),
            ("{0} phải là số nguyên hợp lệ trong phạm vi từ {1}.", "{0} must be a valid integer within the range from {1}."),
            ("{0} phải là số thập phân hợp lệ trong phạm vi từ {1}.", "{0} must be a valid decimal within the range from {1}."),
            ("{0} phải lớn hơn 0.", "{0} must be greater than 0."),
            ("{0} chỉ được có tối đa 10 chữ số sau dấu chấm.", "{0} may contain at most 10 decimal places."),
            ("Số nguyên chỉ được chứa chữ số, một dấu âm ở đầu và tối đa 39 chữ số.", "An integer may contain only digits, one leading minus sign, and at most 39 digits."),
            ("Số thập phân chỉ được chứa chữ số, một dấu âm ở đầu, một dấu chấm và tối đa 10 chữ số sau dấu chấm.", "A decimal may contain only digits, one leading minus sign, one decimal point, and at most 10 decimal places."),
            ("Ví dụ: 12", "Example: 12"),
            ("Ví dụ: 12.5", "Example: 12.5"),
            ("Chu vi", "Perimeter"),
            ("Diện tích", "Area"),
            ("Diện tích theo đường chéo", "Area from diagonals"),
            ("Diện tích theo đáy và chiều cao", "Area from base and height"),
